...
export interface paths {
    ...
    "/engagements/{engagementId}/reports/{reportId}/preview": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Members and platform administrators. Renders the current draft blocks
    ...
    "/engagements/{engagementId}/reports/{reportId}/preview.pdf": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         *     view.
         */
        post: operations["previewReportPdf"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/engagements/{engagementId}/reports/{reportId}/publish": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Lead only. Freezes the current draft blocks, resolved branding, and
    ...
    "/engagements/{engagementId}/reports/{reportId}/versions": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Members and platform administrators with report.read. Returns versions
         *     newest first.
         */
    ...
    "/engagements/{engagementId}/reports/{reportId}/versions/{versionId}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Members and platform administrators with report.read.
         */
    ...
    "/engagements/{engagementId}/reports/{reportId}/versions/{versionId}/html": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Members and platform administrators with report.read. Returns the
         *     frozen HTML as rendered at publish time.
         */
        get: operations["getReportVersionHtml"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/engagements/{engagementId}/reports/{reportId}/versions/{versionId}/pdf": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/engagements/{engagementId}/report-templates": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Members and platform administrators. Returns every template in the
         *     engagement.
         */
    ...
    "/engagements/{engagementId}/report-templates/{templateId}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/engagements/{engagementId}/reports/{reportId}/apply-template": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Replaces the report's draft blocks with a copy of the template blocks
         *     (params deep-copied). Title and branding are left alone.
         */
        post: operations["applyReportTemplate"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/engagements/{engagementId}/report-templates/from-report": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Snapshots the report's current draft blocks into a new template.
         *     The report is not modified.
         */
        post: operations["createReportTemplateFromReport"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        PublishReport: {
            /**
             * @description Include evidence bytes in the published version.
             * @default false
             */
        ...
        ReportVersion: {
            ...
            publishedAt: string;
            includeEvidence: boolean;
            /** @description Always 'lead_full' for published versions. */
            blindScope: string;
        ...
        ReportTemplate: {
            ...
            /** Format: date-time */
            updatedAt: string;
            /** @description Template blocks in ordinal order. Present in GET /report-templates/{templateId} responses; absent from list endpoints. */
            blocks?: components["schemas"]["ReportTemplateBlock"][];
        };
        ReportTemplateBlock: {
            ordinal: number;
            /** @description Stable block id from the catalogue (e.g. "cover", "rich_text"). */
    ...
    parameters: {
        ...
        ReportId: string;
        /** @description The template being read or changed. */
        TemplateId: string;
...
export interface operations {
    ...
    importPlan: {
        ...
        responses: {
            ...
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["ImportPlanResult"];
                };
            };
            400: components["responses"]["BadRequest"];
            401: components["responses"]["Unauthenticated"];
    ...
    previewReport: {
        parameters: {
            query?: {
                /** @description Include evidence blocks in the output. */
                includeEvidence?: boolean;
            };
            header?: {
                /**
        ...
        requestBody?: never;
        responses: {
            /** @description The rendered report as a self-contained HTML document. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    previewReportPdf: {
        ...
        requestBody?: never;
        responses: {
            /** @description The rendered report as a PDF document. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    publishReport: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["PublishReport"];
            };
        };
        responses: {
            /** @description The published version metadata. */
            201: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    listReportVersions: {
        ...
        requestBody?: never;
        responses: {
            /** @description The report's published versions. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    listReportTemplates: {
        ...
        requestBody?: never;
        responses: {
            /** @description The engagement's templates. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    deleteReportTemplate: {
        ...
        requestBody?: never;
        responses: {
            /** @description The template and its blocks are deleted. */
            204: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    patchReportTemplate: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["PatchReportTemplate"];
            };
        };
        responses: {
            /** @description The patched template. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    applyReportTemplate: {
        ...
        responses: {
            /** @description The report with template blocks applied. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    createReportTemplateFromReport: {
        parameters: {
            query?: never;
            header?: {
                /**
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CreateTemplateFromReport"];
            };
        };
        responses: {
            /** @description The created template with the report's blocks. */
            201: {
                headers: {
                    [name: string]: unknown;
                };
