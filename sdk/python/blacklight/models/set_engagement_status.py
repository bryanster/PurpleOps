...
T = TypeVar("T", bound="SetEngagementStatus")


@_attrs_define
class SetEngagementStatus:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        set_engagement_status = cls(
            status=status,
        )

        set_engagement_status.additional_properties = d
        return set_engagement_status
