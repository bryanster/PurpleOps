...
T = TypeVar("T", bound="ActivityEntryDelta")


@_attrs_define
class ActivityEntryDelta:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        activity_entry_delta = cls()

        activity_entry_delta.additional_properties = d
        return activity_entry_delta
