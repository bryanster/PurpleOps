...
T = TypeVar("T", bound="PresenceHeartbeatFocus")


@_attrs_define
class PresenceHeartbeatFocus:
    step_id: UUID | Unset = UNSET
    """ The step the user is currently viewing. """
    execution_id: UUID | Unset = UNSET
    """ The execution the user is currently viewing. """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        presence_heartbeat_focus = cls(
            step_id=step_id,
            execution_id=execution_id,
        )

        return presence_heartbeat_focus
