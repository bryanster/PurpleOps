...
T = TypeVar("T", bound="ContentEmulationPlanStepProcedure")


@_attrs_define
class ContentEmulationPlanStepProcedure:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        content_emulation_plan_step_procedure = cls()

        content_emulation_plan_step_procedure.additional_properties = d
        return content_emulation_plan_step_procedure
