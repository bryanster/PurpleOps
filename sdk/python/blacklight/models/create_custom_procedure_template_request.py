...
T = TypeVar("T", bound="CreateCustomProcedureTemplateRequest")


@_attrs_define
class CreateCustomProcedureTemplateRequest:
    """Body for creating a custom procedure template."""

    name: str
    external_id: str | Unset = UNSET
    """ Optional stable id; defaults to the new row id. """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_custom_procedure_template_request = cls(
            name=name,
        ...
        create_custom_procedure_template_request.additional_properties = d
        return create_custom_procedure_template_request
