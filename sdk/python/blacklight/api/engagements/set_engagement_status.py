...
from ...models.set_engagement_status import SetEngagementStatus
...
def _get_kwargs(
    engagement_id: UUID,
    *,
    body: SetEngagementStatus,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/engagements/{engagement_id}/status".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Transition the engagement to a new status.
     ...
     Lead and platform administrators. The state machine is:
