...
from ...models.patch_member import PatchMember
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/engagements/{engagement_id}/members/{user_id}".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = EngagementMember.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Change a member's engagement role.
     ...
     Lead and platform administrators. The last `lead` cannot be demoted
    ...
    Args:
        engagement_id (UUID):
        user_id (str):
        body (PatchMember): Change a member's engagement role.
