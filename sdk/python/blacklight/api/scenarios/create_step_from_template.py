...
from ...models.create_step_from_template import CreateStepFromTemplate
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/engagements/{engagement_id}/scenarios/{scenario_id}/steps/from-template".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Create a step from a content procedure template.
     ...
     Lead, red and platform administrators. Resolves a procedure template
