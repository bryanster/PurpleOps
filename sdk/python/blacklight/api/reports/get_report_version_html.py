...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/engagements/{engagement_id}/reports/{report_id}/versions/{version_id}/html".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Return the rendered HTML of a published version.

     Members and platform administrators with report.read. Returns the
    frozen HTML as rendered at publish time.
