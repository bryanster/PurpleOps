...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/engagements/{engagement_id}/reports/{report_id}/versions/{version_id}".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ReportVersion.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Return one published version's metadata.
