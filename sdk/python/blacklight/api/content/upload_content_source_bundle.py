...
from ...models.upload_content_bundle_request import UploadContentBundleRequest
...
def _get_kwargs(
    source_id: UUID,
    *,
    body: UploadContentBundleRequest,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/content/sources/{source_id}/bundle".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Upload an offline content bundle for a source.
     ...
     Administrators only (`content.sync`). Accepts a multipart release archive
    ...
    Args:
        ...
        body (UploadContentBundleRequest): Multipart offline bundle upload. `file` is the release
            archive; optional
