...
| **M0b — Foundations** | in progress — 10/14 done | [14 tickets](#m0b--foundations) |
...
| [M0B-011](M0B-011-docker.md) | Dockerfile (CGO + Chromium) and compose | M |
| [M0B-012](M0B-012-ci.md) | CI: lint, test, build matrix, codegen-drift gate | M |
...
| [M1-005](M1-005-csrf.md) | CSRF double-submit for cookie sessions | M |
