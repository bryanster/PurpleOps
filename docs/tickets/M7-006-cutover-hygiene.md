...
- [ ] `docs/tickets/README.md` shows M7 refined with linked tickets; M5/M6 completion state matches
      reality.
- [ ] CI primary path is `main`; `v2` either removed or justified in docs.
- [ ] `make build` stamped version default does not claim `v2-dev` as the product line.
